...
namespace cgicc {
  ...
  public:
     ...
     */
    Cgicc(std::string &query, std::string &cookie, std::string &data, std::string &type);
    ...
    Cgicc(const Cgicc& cgi)
      : fQueryString(cgi.fQueryString), fCookie(cgi.fCookie), fPostData(cgi.fPostData), fQueryType(cgi.fQueryType)
    { operator=(cgi); }
    ...
    { return (this->fPostData == cgi.fPostData 
           && this->fCookie   == cgi.fCookie 
           && this->fQueryType == cgi.fQueryType 
           && this->fQueryString == cgi.fQueryString); }
